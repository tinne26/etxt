...
![](https://github.com/tinne26/etxt/blob/v0.0.10/docs/img/outline_vs_raster.png?raw=true)
...
![](https://github.com/tinne26/etxt/blob/v0.0.10/docs/img/glyph_filled.png?raw=true)
...
![](https://github.com/tinne26/etxt/blob/v0.0.10/docs/img/glyph_edges.png?raw=true)
...
![](https://github.com/tinne26/etxt/blob/v0.0.10/docs/img/glyph_sign.png?raw=true)
...
I'd explain more, but at this point you have enough context and jumping directly [into the code](https://github.com/tinne26/etxt/blob/v0.0.10/emask/edge_marker.go) may be the best next step.
