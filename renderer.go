...
//
// [general reference]: https://github.com/tinne26/etxt/blob/v0.0.10/docs/px-size.md
...
//
// [this guide]: https://github.com/tinne26/etxt/blob/v0.0.10/docs/display-scaling.md
